export default {
  ...
  INTRODUCTION: {
    ...
    RESPONSIBILITY: {
      ...
      BACKUP: {
        ...
        OPTIONS: 'You can write it down on thick paper and store multiple copies in secure locations. You can also store it on an encrypted flash drive. Alternatively, you can use a Ledger Nano S USB hardware device, available at Ledger.com, to store and access your funds and the Phantom Desktop Wallet. You can plug your Ledger Nano S into your computer and access the ARK blockchain without needing to enter your passphrase.'
      },
    ...
    TURN: {
      ...
      CONCLUSION: 'Everyone here on the ARK.io team hopes you enjoy using the Phantom Desktop Wallet to participate in the blockchain revolution!'
    }
  },
  ...
  PAGES: {
    ...
    PLUGIN_MANAGER: {
      ...
      DISCLAIMER: '<b>Disclaimer:</b> The availability of this plugin in the Phantom Desktop Wallet does not mean that either ARK.io or ARK SCIC is directly involved in the development or affiliated with the developer providing this plugin. By installing it on your wallet, you assume every responsibility.',
